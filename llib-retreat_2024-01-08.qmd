...
:::: {.columns}
::: {.column width="62%"}
* Fear of **lower participation** due to data-sharing clauses, particularly with certain **data types** (e.g., video data)<br />`r fa("long-arrow-right")` Challenge for data sharing practices<br /><br />
* Unclear reaction to more recent types of **"participant ID"** (e.g., to match several data sets)<br /><br /><br /><br />
