...
__Do participants read consent forms?__  
_(spend enough time on informed consent pages in online surveys to plausibly read and process the information presented?)_
...
__Who reads consent forms?__  
_What individual characteristics predict whether participants read and understand informed consent forms?_
...
* Predictors<br />`r fa("square-plus")` Perceived Trust<br />`r fa("square-plus")` Perceived Risk of Participation<br />`r fa("square-plus")` Experience as Research Participant<br />`r fa("square-plus")` Experience Conducting Studies
